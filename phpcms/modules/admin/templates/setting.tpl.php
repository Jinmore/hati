...
<table width="100%"  class="table_form">
  ...
  <tr>
	...
	<tr>
		<th width="120">顶部电话</th>
		<td class="y-bg"><input type="text" class="input-text" name="setconfig[tel]" id="tel" size="50" value="<?php echo TEL?>"/></td>
	</tr>
	<tr>
		<th width="120">顶部QQ号</th>
		<td class="y-bg"><input type="text" class="input-text" name="setconfig[qqhao]" id="qqhao" size="50" value="<?php echo QQHAO?>"/></td>
	</tr>
	<tr>
		<th width="120">底部ICP备案号</th>
		<td class="y-bg"><input type="text" class="input-text" name="setconfig[icp]" id="icp" size="50" value="<?php echo ICP?>"/></td>
	</tr>
</table>
</div>
